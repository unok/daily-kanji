...
import questionsElementary1Part7 from '../data/questions/questions-elementary1-part7.json'
// Elementary 2 parts
...
import questionsElementary2Part9 from '../data/questions/questions-elementary2-part9.json'
import questionsElementary2Part10 from '../data/questions/questions-elementary2-part10.json'
// Elementary 3 parts
...
import questionsElementary3Part9 from '../data/questions/questions-elementary3-part9.json'
import questionsElementary3Part10 from '../data/questions/questions-elementary3-part10.json'
// Elementary 4 parts
...
import questionsElementary4Part9 from '../data/questions/questions-elementary4-part9.json'
import questionsElementary4Part10 from '../data/questions/questions-elementary4-part10.json'
import questionsElementary4Part11 from '../data/questions/questions-elementary4-part11.json'
import questionsElementary4Part12 from '../data/questions/questions-elementary4-part12.json'
import questionsElementary4Part13 from '../data/questions/questions-elementary4-part13.json'
// Elementary 5 parts
...
import questionsElementary5Part9 from '../data/questions/questions-elementary5-part9.json'
import questionsElementary5Part10 from '../data/questions/questions-elementary5-part10.json'
// Elementary 6 parts
...
import questionsElementary6Part10 from '../data/questions/questions-elementary6-part10.json'
// Junior parts
...
function mergeQuestionSets(
  ...
  title: string,
  description: string,
  ...parts: Array<{ questions: Array<{ id?: string; sentence: string }> }>
): QuestionSet {
...
const questionSets: Record<string, QuestionSet> = {
  ...
  junior: mergeQuestionSets(
    ...
    '中学校卒業レベル',
    '中学校で習う漢字を使った問題です',
    questionsJuniorPart1,
    questionsJuniorPart2,
    questionsJuniorPart3,
    questionsJuniorPart4,
    questionsJuniorPart5,
    questionsJuniorPart6,
    questionsJuniorPart7,
    questionsJuniorPart8,
    questionsJuniorPart9,
    questionsJuniorPart10,
    questionsJuniorPart11,
    questionsJuniorPart12,
    questionsJuniorPart13,
    questionsJuniorPart14,
    questionsJuniorPart15,
    questionsJuniorPart16,
  ...
  elementary1: mergeQuestionSets(
    ...
    '小学1年生レベル',
    '小学1年生で習う漢字を使った問題です',
    questionsElementary1Part1,
    questionsElementary1Part2,
    questionsElementary1Part3,
    questionsElementary1Part4,
    questionsElementary1Part5,
    questionsElementary1Part6,
    questionsElementary1Part7
  ),
  elementary2: mergeQuestionSets(
    'elementary2',
    '小学2年生レベル',
    '小学2年生で習う漢字を使った問題です',
    questionsElementary2Part1,
    questionsElementary2Part2,
    questionsElementary2Part3,
    questionsElementary2Part4,
    questionsElementary2Part5,
    questionsElementary2Part6,
    questionsElementary2Part7,
    questionsElementary2Part8,
    questionsElementary2Part9,
    questionsElementary2Part10
  ),
  elementary3: mergeQuestionSets(
    'elementary3',
    '小学3年生レベル',
    '小学3年生で習う漢字を使った問題です',
    questionsElementary3Part1,
    questionsElementary3Part2,
    questionsElementary3Part3,
    questionsElementary3Part4,
    questionsElementary3Part5,
    questionsElementary3Part6,
    questionsElementary3Part7,
    questionsElementary3Part8,
    questionsElementary3Part9,
    questionsElementary3Part10
  ),
  elementary4: mergeQuestionSets(
    'elementary4',
    '小学4年生レベル',
    '小学4年生で習う漢字を使った問題です',
    questionsElementary4Part1,
    questionsElementary4Part2,
    questionsElementary4Part3,
    questionsElementary4Part4,
    questionsElementary4Part5,
    questionsElementary4Part6,
    questionsElementary4Part7,
    questionsElementary4Part8,
    questionsElementary4Part9,
    questionsElementary4Part10,
    questionsElementary4Part11,
    questionsElementary4Part12,
    questionsElementary4Part13
  ),
  elementary5: mergeQuestionSets(
    'elementary5',
    '小学5年生レベル',
    '小学5年生で習う漢字を使った問題です',
    questionsElementary5Part1,
    questionsElementary5Part2,
    questionsElementary5Part3,
    questionsElementary5Part4,
    questionsElementary5Part5,
    questionsElementary5Part6,
    questionsElementary5Part7,
    questionsElementary5Part8,
    questionsElementary5Part9,
    questionsElementary5Part10
  ),
  elementary6: mergeQuestionSets(
    'elementary6',
    '小学6年生レベル',
    '小学6年生で習う漢字を使った問題です',
    questionsElementary6Part1,
    questionsElementary6Part2,
    questionsElementary6Part3,
    questionsElementary6Part4,
    questionsElementary6Part5,
    questionsElementary6Part6,
    questionsElementary6Part7,
    questionsElementary6Part8,
    questionsElementary6Part9,
    questionsElementary6Part10
  ),
}

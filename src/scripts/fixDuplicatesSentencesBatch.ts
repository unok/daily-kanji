...
const duplicateFixPatterns: Record<string, string[]> = {
  'ねこの[毛|け]がふわふわです。': ['白いねこの[毛|け]がふわふわです。', '子ねこの[毛|け]がとてもふわふわです。'],
  'こちらの[方|ほう]がよいです。': ['こちらの[方|ほう]の道がよいです。', 'こちらの[方|ほう]角がよいです。'],
  'おんがくを[聞|き]きました。': ['美しいおんがくを[聞|き]きました。', '教室でおんがくを[聞|き]きました。'],
  '昨日[本|ほん]を[読|よ]みました。': ['昨日図書館で[本|ほん]を[読|よ]みました。', '昨日面白い[本|ほん]を[読|よ]みました。'],
  'きれいな[絵|え]をかきました。': ['きれいな[絵|え]を上手にかきました。', '友達ときれいな[絵|え]をかきました。'],
  'せんせいが[教|おし]えてくれました。': ['やさしいせんせいが[教|おし]えてくれました。', 'せんせいが丁寧に[教|おし]えてくれました。'],
  'ことりが[鳴|な]いています。': ['窓の外でことりが[鳴|な]いています。', '朝からことりが美しく[鳴|な]いています。'],
  '[工|こう]じょうをみました。': ['大きな[工|こう]じょうをみました。', '家族で[工|こう]じょう見学をしました。'],
  'しろい[馬|ば]がいました。': ['野原にしろい[馬|ば]がいました。', '牧場でしろい[馬|ば]を見ました。'],
  '[牛|ぎゅう]にゅうをのみました。': ['朝食で[牛|ぎゅう]にゅうをのみました。', '冷たい[牛|ぎゅう]にゅうをのみました。'],
}
